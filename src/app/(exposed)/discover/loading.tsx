...
export default function loading() {
  const articlesArray: number[] = new Array(3).fill(0);
    ...
    <main className="w-full max-w-3xl mx-auto">
      ...
      <section className="space-y-3 mb-12">
        <div className="flex items-center justify-between">
          <div className="bg-white/5 border border-white/5 rounded-lg w-14 h-3"></div>
          <div className="bg-white/5 border border-white/5 rounded-lg w-16 h-5"></div>
        </div>
